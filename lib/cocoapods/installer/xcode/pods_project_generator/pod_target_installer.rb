        ...
        class PodTargetInstaller < TargetInstaller
          ...
          def add_target
            super.tap do |native_target|
              remove_pod_target_xcconfig_overrides_from_target(target.build_settings_by_config, native_target)
            end
          end
          ...
          def create_xcconfig_file(native_target, resource_bundle_targets)
            target.user_config_names_by_config_type.each do |config, names|
              ...
              update_changed_file(target.build_settings_by_config[config], path)
